...
(function withAngular(angular) {
  ...
  var directiveName = 'socialshare'
    ...
    ,smsShare = function smsShare($window, attrs) {

    var body = encodeURIComponent(attrs.socialshareText.replace('%','percent')) + '%0A' + encodeURIComponent(attrs.socialshareUrl);
    var toPhoneNumber = attrs.socialshareTo || '';
    var urlString = 'sms:' + toPhoneNumber + '?&body=' + body;
    window.open(urlString, "_blank", "scrollbars=1,width=640,height=300");
    }
