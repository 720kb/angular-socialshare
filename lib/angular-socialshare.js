    ...
    , socialshareDirective = /*@ngInject*/ function socialshareDirective($window, $location, socialshareConf) {
        ...
        var linkingFunction = function linkingFunction($scope, element, attrs) {
            ...
            if (configurationElement) {
                console.log('Found configuration for provider : ' + attrs.socialshareProvider);
            } else {
   ...
   , manageFacebookShare = function manageFacebookShare($window, $location, attrs) {
       ...
       if (attrs.socialshareType && attrs.socialshareType === 'feed') {
           ...
           $window.open(
             ...
             + ',top=' + (window.innerHeight - attrs.socialsharePopupHeight) / 2 + ',left=' + (window.outerWidth - attrs.socialsharePopupWidth) / 2);
